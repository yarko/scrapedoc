...
all: html inlineslides slides epub
...
qthelp:
	...
	@echo "# qcollectiongenerator $(BUILDDIR)/qthelp/Scrape.qhcp"
	@echo "To view the help file:"
	@echo "# assistant -collectionFile $(BUILDDIR)/qthelp/Scrape.qhc"
...
devhelp:
	...
	@echo "Build finished."
	@echo "To view the help file:"
	@echo "# mkdir -p $$HOME/.local/share/devhelp/Scrape"
	@echo "# ln -s $(BUILDDIR)/devhelp $$HOME/.local/share/devhelp/Scrape"
	@echo "# devhelp"
...
# support for the slide builder extension, hieroglyph:
#
